...
import certificationsHero from '../assets/certifications-hero.jpg';
    ...
    return (
        <div className="certifications-page">
            ...
            <section
                ...
                style={{
                    backgroundImage: `linear-gradient(rgba(15, 23, 42, 0.7), rgba(15, 23, 42, 0.8)), url(${certificationsHero})`,
                ...
                <div className="container">
                    <div className="cta-box">
                        ...
                        <div className="cta-buttons">
                            ...
                            <a href="https://tidycal.com/weblearnaisocialmedia/30-minute-meeting" data-tidy="popup" className="btn btn-secondary" style={{ background: '#2563eb', border: 'none', color: 'white', padding: '1rem 3rem', fontWeight: 'bold' }}>
                                Talk to Advisor
                            </a>
                        </div>
                    </div>
